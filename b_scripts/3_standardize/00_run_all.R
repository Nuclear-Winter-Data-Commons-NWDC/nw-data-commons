...
source("b_scripts/3_standardize/uv_radiation_cleaning.R")
source("b_scripts/3_standardize/agriculture_agmip_cleaning.R")
source("b_scripts/3_standardize/agriculture_clm_cleaning.R")
source("b_scripts/3_standardize/fish_catch_cleaning.R")
source("b_scripts/3_standardize/sea_ice_cleaning.R")
source("b_scripts/3_standardize/starvation_cleaning.R")
...
source("b_scripts/3_standardize/00_utils_export.R")

# 6. Optionally run example analyses
# source("b_scripts/4_analysis_examples/example_visualization.r")