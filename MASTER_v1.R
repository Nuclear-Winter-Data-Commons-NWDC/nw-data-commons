...
# 2-CLEANING & RESHAPING --------------------------------------------------------------------------------
  ...
  #1. TEMPERATURE & PRECIPITATION ----
    ...
    # Import Raw Files & Combine into Tables
      ...
      ImportTempPrecip <- function(directory, num_files = NULL) {  # Define the overarching import function that will be applied through all of the files in each directory
      ...
      # Directories and file information
        ...
        # Append specific subdirectories
          directories <- list(
            cntrl_03 = paste0(source.tables.dir, "/nw_cntrl_03.TS_TSMN_TSMX_PRECC_PRECL.nc", collapse = ""),
            targets_04 = paste0(source.tables.dir, "/nw_targets_04.TS_TSMN_TSMX_PRECC_PRECL.nc.tar", collapse = ""),
            targets_05 = paste0(source.tables.dir, "/nw_targets_05.TS_TSMN_TSMX_PRECC_PRECL.nc.tar", collapse = ""),
            ur_150 = paste0(source.tables.dir, "/nw_targets_05.TS_TSMN_TSMX_PRECC_PRECL.nc.tar", collapse = "")
          )
      ...
      # Compile list into single table
        Compile_TempPrecip <-
    ...
    # Create Basic Product: geospatial merge to map grids onto geographic units
