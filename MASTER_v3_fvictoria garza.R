...
# 0-SETUP --------------------------------------------------------------------------------
  ...
  # LOAD LIBRARIES/PACKAGES
    ...
    #LoadCommonPackages()
    library(googledrive)
    drive_auth(email = "victoriaalejandra1149@gmail.com")
  ...
  ###########VG: Add the funcitons here#################
    ...
    #####END of VG adding wnf functions###
  ...
  # SECTION CLOCKING
    ...
    gs4_auth(email = "victoriaalejandra1149@gmail.com")
